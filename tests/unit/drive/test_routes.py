...
class TestListFiles:
    ...
    def test_list_files_success(self, mock_drive_service, test_client_with_mocks):
        ...
        mock_drive_service.list_files = AsyncMock(
            return_value=[
                DriveFile(
                    id="file1",
                    name="video1.mp4",
...
class TestScanFolder:
    ...
    def test_scan_folder_success(self, mock_drive_service, test_client_with_mocks):
        ...
        mock_drive_service.scan_folder = AsyncMock(
            return_value=DriveFolder(
                id="folder123",
                name="Test Folder",
                files=[],
                subfolders=[],
...
class TestGetFileInfo:
    ...
    def test_get_file_info_success(self, mock_drive_service, test_client_with_mocks):
        ...
        mock_drive_service.get_file_metadata = AsyncMock(
            return_value={
                "id": "file123",
                "name": "test_video.mp4",
                "mimeType": "video/mp4",
...
class TestUploadFolder:
    ...
    def test_upload_folder_empty_success(
        self, mock_drive_service, test_client_with_mocks
    ):
        """Test folder upload with no videos."""
        mock_drive_service.get_folder_info = AsyncMock(
            return_value={"id": "folder123", "name": "My Videos"}
        )
