...
class TestLoginPage:
    ...
    def test_login_page_renders(self, test_client_no_session):
    ...
    def test_login_page_redirects_when_authenticated(self, test_client_with_session):
...
class TestLoginSubmit:
    ...
    def test_login_submit_success(self, test_client):
    ...
    def test_login_submit_invalid_credentials(self, test_client):
...
class TestDashboard:
    ...
    def test_dashboard_requires_auth(self, test_client_no_session):
    ...
    def test_dashboard_renders_for_authenticated_user(
        self, mock_oauth_service, test_client_with_session
    ):
...
class TestGoogleOAuth:
    ...
    def test_google_login_redirect(self, mock_oauth_service, test_client_with_session):
    ...
    def test_google_login_requires_auth(self, test_client_no_session):
    ...
    def test_oauth_callback_success(self, mock_oauth_service, test_client_with_session):
...
class TestAuthStatus:
    ...
    def test_auth_status_unauthenticated(self, test_client_no_session):
...
class TestLogout:
    ...
    def test_logout_clears_session(self, mock_oauth_service, test_client_with_session):
